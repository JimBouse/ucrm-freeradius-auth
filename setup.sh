...
# Installing packages 
 ...
 read -p "Install mariadb-server freeradius freeradius-mysql apache2 php libapache2-mod-php php-mysql php-curl and composer? y/n " -n 1 -r
 echo    # (optional) move to a new line
 if [[ $REPLY =~ ^[Yy]$ ]]
 then
  apt install mariadb-server freeradius freeradius-mysql apache2 php libapache2-mod-php php-mysql php-curl composer -y
 fi
